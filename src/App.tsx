...
import SvgAddToDomComp from './SvgAddToDomComp.tsx';
...
const maxPrice = Math.max(...prices);
  ...
  // Apply filters to polygons and using the dom api as you asked for
  const applyFilters = () => {
    ...
    <>
     ...
     handleMaxChange = {handleMaxChange} />
      ...
      hoveredPolygon && (
        ...
        >
          <div className={styles.item_show_hover}>
            <span >Status</span>
            <span className={`${styles.data_item_show_hover} ${styles.data_item_show_hover_status}`}>{hoveredPolygon.status}</span>
          </div>

          <div className={styles.item_show_hover}>
            <span >Price</span>
            <span className={`${styles.data_item_show_hover} ${styles.data_item_show_hover_price}`}>${hoveredPolygon.price}</span>
          </div>
